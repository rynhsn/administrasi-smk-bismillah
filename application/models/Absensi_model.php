...
class Absensi_model extends CI_Model
{
    ...
    {
        // ketentuan file
        $config['upload_path']          = './assets/dist/upload/absensi/';
    ...
    private function _deleteFile($id)
    {
        ...
        if ($absensi['file'] != "test.pdf") {
            $filename = explode(".", $absensi['file'])[0];
            return array_map('unlink', glob(FCPATH . "assets/dist/upload/absensi/$filename.*"));
        }
    }
}
