            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12 order-1 order-md-2">
                    <div class="card card-primary card-outline">
                        <!-- form start -->
                        <form class="form-group" action="<?= base_url($role['menu'] . '/editlpj/' . $detail['id']); ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="form-control form-control-sm <?= form_error('kegiatan') == true ? 'is-invalid' : ''; ?>" name="kegiatan" id="kegiatan" value="<?= $detail['nama_kegiatan']; ?>" placeholder="Nama Kegiatan">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm">
                                                <input type="number" class="form-control form-control-sm <?= form_error('tahun') == true ? 'is-invalid' : ''; ?>" name="tahun" id="tahun" value="<?= $detail['tahun']; ?>" placeholder="Tahun">
                                                <div class="invalid-feedback">
                                                    <?= form_error('tahun'); ?>
                                                </div>
                                            </div>
