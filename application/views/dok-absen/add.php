            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-12 order-1 order-md-2">
                    <div class="card card-primary card-outline">
                        <!-- form start -->
                        <form class="form-group" action="<?= base_url($role['menu'] . '/addabsen'); ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-md-6">
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-sm">
                                                <select class="form-control form-control-sm col-sm-6" id="kelas" name="kelas">
                            ...
                            <div class="card-footer">
                                <a href="<?= base_url($role['menu'] . '/absensi'); ?>" type="button" class="btn btn-default">Batal</a>
